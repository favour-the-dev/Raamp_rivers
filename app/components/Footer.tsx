    ...
    return ( 
        <>
            <footer className="bg-[#1E201E] text-white">
                <div className="p-4 wrapper-cont grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 content-start place-items-center">
                    ...
                    <div className="flex flex-col items-start gap-3">
                        ...
                        <p className="flex items-center gap-1"><CiPhone /> +234 803 670 2642</p>
                        <p className="flex items-center gap-1"><CiMail /> RiversState@raamp.gov.ng</p>
                    </div>
                </div>
                <div className="bg-black">
                    <div className="wrapper-cont flex flex-col md:flex-row items-center justify-center md:justify-between">
